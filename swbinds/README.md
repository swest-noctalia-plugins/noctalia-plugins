...
Based on [Keybind Cheatsheet](https://github.com/noctalia-dev/noctalia-plugins/tree/main/keybind-cheatsheet) by **blacku**, published in the official Noctalia plugins repo. This fork is maintained by **swest**.
