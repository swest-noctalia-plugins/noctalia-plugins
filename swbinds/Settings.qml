...
Item {
    ...
    ColumnLayout {
        ...
        property string editFishConfigPath: cfg.fishConfigPath || defaults.fishConfigPath || "~/.config/fish/config.fish"
        property bool editShowFishAliases: cfg.showFishAliases ?? defaults.showFishAliases ?? true
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    NTextInput {
                        ...
                        onTextChanged: {
                            if (text.length > 0)
                                root.editHyprlandConfigPath = text;
                        }
                    }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        NText {
                            text: rootItem.pluginApi?.tr("settings.fish-path")
                            color: Color.mOnSurface
                            pointSize: Style.fontSizeM
                            font.weight: Style.fontWeightBold
                        }
                    ...
                    NToggle {
                        id: fishAliasToggle
                        label: rootItem.pluginApi?.tr("settings.show-fish-aliases")
                        checked: root.editShowFishAliases
                        onToggled: function (checked) {
                            root.editShowFishAliases = checked;
                        }
                    }
                    ...
                    NTextInput {
                        ...
                        Layout.fillWidth: true
                        Layout.preferredHeight: Style.baseWidgetSize
                        text: root.editFishConfigPath
                        placeholderText: "~/.config/fish/config.fish"
                        enabled: root.editShowFishAliases
                        opacity: enabled ? 1.0 : 0.5

                        onTextChanged: {
                            if (text.length > 0)
                                root.editFishConfigPath = text;
                        }
                    }

                    NText {
                        Layout.fillWidth: true
                        text: rootItem.pluginApi?.tr("settings.fish-path-hint")
                        color: Color.mOnSurfaceVariant
                        pointSize: Style.fontSizeXS
                        wrapMode: Text.WordWrap
                    }
                    ...
                    NText {
                        Layout.fillWidth: true
                        text: rootItem.pluginApi?.tr("settings.show-fish-aliases-hint")
                        color: Color.mOnSurfaceVariant
                        pointSize: Style.fontSizeXS
                        wrapMode: Text.WordWrap
                    }
                ...
                RowLayout {
                    ...
                    NButton {
                        ...
                        onClicked: {
                            ...
                            ToastService.showNotice(rootItem.pluginApi?.tr("settings.refresh-message"));
                        }
                    }
                    ...
                    NButton {
                        ...
                        onClicked: {
                            ...
                            root.editFishConfigPath = defaults.fishConfigPath || "~/.config/fish/config.fish";
                            root.editShowFishAliases = defaults.showFishAliases ?? true;
                            ...
                            fishPathInput.text = root.editFishConfigPath;
                            ...
                            ToastService.showNotice(rootItem.pluginApi?.tr("settings.reset-message"));
                        }
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    NText {
                        ...
                        text: "qs -c \"noctalia-shell\" ipc call plugin:swbinds toggle"
    ...
    function saveSettings() {
        ...
        pluginApi.pluginSettings.fishConfigPath = root.editFishConfigPath;
        pluginApi.pluginSettings.showFishAliases = root.editShowFishAliases;
